...
const My_applications = (props) => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            console.log("SOME ERROR IN UPDATING MASTER ARRAY");
        }
    }, []);
                            ...
                            return (
                                <tr key={curr_app._id}>
                                    ...
                                    <td key={curr_app._id + "f"}>
                                        {(curr_app.application_id.job_rating === -1 || curr_app.application_id.job_rating === undefined) && (
                                        ...
                                        {(curr_app.application_id.job_rating !== -1 && curr_app.application_id.job_rating !== undefined) && (
                                            <p> Already rated as {curr_app.chosen_rating}</p>
                                        )}
                                    </td>
